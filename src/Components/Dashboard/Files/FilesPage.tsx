    ...
    <div className="pt-20">
      <div className="flex items-center justify-between">
        ...
        <div className="flex justify-end pt-2 pb-8 mr-5 gap-5">
          <FolderButton path={path} /> <UploadButton /> <Link href={"/dashboard/create-file"}><button className="text-xs md:text-[16px]  border-0 btn bg-primary text-white hover:bg-blue-600 transition-all duration-300"><IoCreateOutline className="text-xl  "/>
                <span className="hidden md:block">Create File</span></button></Link>
        </div>
      </div>
      <div
