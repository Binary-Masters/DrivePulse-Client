            ...
            <div className="modal-box">
                ...
                <div className="space-y-2">
                    ...
                    <div className="form-control mt-6 flex flex-row justify-between gap-2 ">
                        <button className="flex gap-2 text-blue-600 bg-white border border-sky-500 focus:outline-none hover:bg-gray-100 focus:ring-1 focus:ring-gray-200 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2"><FaLink /> Copy link</button>
