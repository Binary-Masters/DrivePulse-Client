...
const UploadForm: React.FC = () => {
  ...
  const { user } = useAuth();
  const { uploadFile, getFileURL, setUploadProgress, setUploadFileInfo } =
    useStorage();
    ...
    <div className="mx-3">
      <div className="flex items-center justify-center w-full  mt-5">
        <label
          ...
          className="flex flex-col items-center justify-center w-full h-72 border-2 border-gray-300 border-dashed rounded-lg shadow-lg cursor-pointer ">
          <div className="flex flex-col items-center justify-center pt-5 pb-6">
            ...
            <p className="mb-2 text-sm text-gray-300 ">
              ...
              <span className="font-medium text-primary">drag</span> and{" "}
              <span className="font-medium text-primary">drop</span>
            </p>
            <p className="text-xs font-medium text-slate-400">SVG, PNG, JPG</p>
          </div>
          <input
            id="dropzone-file"
            type="file"
      ...
      {file && (
        <div
          ...
          className="relative flex items-center justify-between  p-5 mt-5 border border-gray-400 shadow-md rounded-md">
