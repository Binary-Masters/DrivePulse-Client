  ...
  return (
    <div className="mx-3">
      <div className="flex items-center justify-center w-full max-w-3xl mx-auto mt-5">
        ...
        //   }}
		style={{backdropFilter:"blur(150px)",boxShadow:"1px 1px 20px #24207b"}}
      ...
      {
		file && <div style={{backdropFilter:"blur(150px)"}} className="relative flex items-center justify-between max-w-3xl p-5 mx-auto mt-5 border border-gray-400 shadow-md rounded-md">
